        ...
        <div class="col-md-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <?php endif; ?>
                    <form action="/admin/edit_profil/<?= user()->email; ?>" method="POST" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <input type="hidden" name="id_user" value="<?= user()->id; ?>">
                        <input type="hidden" name="profil" value="<?= user()->user_image; ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control <?= ($validation->hasError('nama')) ? 'is-invalid' : ''; ?>" id="nama" name="nama" value="<?= user()->fullname; ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="row">
                                    <div class="col-sm-3">
                                        <img src=" <?= base_url('/admin/img') . '/' . user()->user_image; ?>"" class=" img-thumbnail img-preview">
                                    </div>
                                    <div class="col-sm-9">
                                        ...
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label" style="font-size: 14px;"><?= user()->user_image; ?></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
