        ...
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary text-uppercase" style="font-size: 14px;">Add Blog</h6>
                </div>
                <div class="card-body">

                    <form class="user" method="POST" action="/blog/save" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <div class=" col-md-12">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control <?= ($validation->hasError('title')) ? 'is-invalid' : ''; ?>" id="judul" name="title" autofocus value="<?= old('title'); ?>" style="font-size: 12px;" placeholder="Title Blog">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="editor" name="blog" class="form-control col-md-7 col-xs-12 <?= ($validation->hasError('blog')) ? 'is-invalid' : ''; ?>"></textarea>
                                        <div class="invalid-feedback">
